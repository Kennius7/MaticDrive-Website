...
const Banner = () => {
  return (
    <div className={`justify-center items-center relative mb-6`}>
        <video src={MaticVid1} className="w-full xs:block hidden" width="1000" height="500" autoPlay muted loop playsInline />
        <img src={MaticVid2} className={`xs:hidden block w-[100%] h-[220px]`} alt="Banner Photo" />
