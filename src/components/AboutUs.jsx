...
const FeatureCard = ({ icon, title, content, index }) => (
  <div className={`flex flex-row p-6 rounded-[20px] ${index !== features.length - 1 ? "mb-6" : "mb-0"} feature-card2`}>
    <div className={`w-[64px] h-[64px] rounded-full ${styles.flexCenter} bg-dimWhite -mt-2`}>
    ...
    <div className="flex-1 flex flex-col ml-3">
      ...
      <p className="font-poppins font-normal italic text-primary text-[14px] leading-[16px]">
        {content}
      </p>
    </div>
  </div>
