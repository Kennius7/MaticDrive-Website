      ...
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        <div className="flex flex-row items-center py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2">
          ...
          <p className={`${styles.paragraph} ml-2 text-white`}>
            <span className="text-white">Get</span><span className="text-white"> the best prices for our{" "}</span>
            <span className="text-gradient">MaticDrive Cars</span><span className="text-white"> soon!</span>
          </p>
        </div>
